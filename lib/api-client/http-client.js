...
HttpClient.prototype.post = function(path, options) {
  ...
  var config = Object.assign({'X-XSRF-TOKEN': lastCookies['XSRF-TOKEN']}, this.config.headers);
...
HttpClient.prototype.load = function(url, options) {
  ...
  var config = Object.assign({'X-XSRF-TOKEN': lastCookies['XSRF-TOKEN']}, options.headers || this.config.headers);
