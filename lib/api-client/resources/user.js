 ...
 * @param {Object} options
 * @param {String} options.id                           The user's (who will be updated) id
...
/**
 * Delete a user
 * @param  {Object|String} options You can either pass an object (with at least a id property) or the id of the user to be deleted
 * @param  {String} options.id
 * @param  {Function} done
 */
