 ...
 * @param  {requestCallback} [done]
 */
AbstractClientResource.update = function(ids, attributes, done) {};
 ...
 * @param  {requestCallback} [done]
 */
AbstractClientResource.delete = function(ids, done) {};
 ...
 * @abstract
 *
 * @memberof CamSDK.AbstractClientResource.prototype
 *
 * @param  {Object}   attributes
 * @param  {requestCallback} [done]
 */
AbstractClientResource.prototype.update = function(attributes, done) {};
 ...
 * @param  {requestCallback} [done]
 */
AbstractClientResource.prototype.delete = function(done) {};
